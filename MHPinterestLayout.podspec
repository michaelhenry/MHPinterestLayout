...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MHPinterestLayout.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Michael Henry Pantaleon/MHPinterestLayout'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Michael Henry Pantaleon' => 'me@iamkel.net' }
  s.source           = { :git => 'https://github.com/Michael Henry Pantaleon/MHPinterestLayout.git', :tag => s.version.to_s }
